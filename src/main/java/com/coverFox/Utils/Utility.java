...
public class Utility {
	...
	public static String readDataFromExcel(String sheetName, int row, int cell) throws EncryptedDocumentException, IOException {
		FileInputStream myfile = new FileInputStream("F:\\Automation\\Project clone\\CoverFox clone\\src\\main\\resources\\testData\\testData.xlsx");
	...
	public static String readDataFromPropertiesFile(String key) throws IOException {
		FileInputStream myFile = new FileInputStream("F:\\Automation\\Project clone\\CoverFox clone\\src\\main\\resources\\config\\config.properties");
